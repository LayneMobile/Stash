...
import stash.retrofit.internal.RetrofitStashModule;

public interface Retrofittable<S> {
    S getService();

    final class Builder<S> implements stash.Builder<Retrofittable<S>> {
        private Class<S> serviceType;
        private Func0<RestAdapter> restAdapter;

        @NonNull public Builder<S> setServiceType(@NonNull Class<S> serviceType) {
            this.serviceType = serviceType;
            return this;
        }

        @NonNull public Builder<S> setRestAdapter(@NonNull RestAdapter restAdapter) {
            return setRestAdapterInternal(this, restAdapter);
        }

        @NonNull public Builder<S> setRestAdapter(@NonNull Func0<RestAdapter> restAdapter) {
            this.restAdapter = restAdapter;
            return this;
        }

        @NonNull @Override public Retrofittable<S> build() {
